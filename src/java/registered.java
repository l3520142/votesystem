...
private static final long serialVersionUID = 1L;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //
        String imgurl="C:/WebFinal/web/dbpic/" + filename;        
        SQLCustomer sa=new SQLCustomer(name,email,password,imgurl);
        sa.add();
        
        session.setAttribute("SA", sa);//更動		
        response.sendRedirect("member_management.jsp");}//更動
        else
        {
            session.setAttribute("ER", "密碼確認錯誤，請重新輸入");
        ...
        OutputStream out = new FileOutputStream("C:/WebFinal/web/dbpic/" + filename);
